...
description: "2026-05-17 AI 要闻汇总(6 篇):Microsoft AI CEO 预警：白领工作或在 18 个月内被 AI 全面自动化;Grok V9 1.5T 模型或将于夏季发布：xAI 完成基础训练并进入补充训练阶段;Claude Code 避坑指南:8 个最容易翻车的使用误区与解法…"
date: 2026-05-17
---
