...
description: "2026-05-28 AI 要闻汇总(5 篇):Claude Voice Mode 或将支持中文，新增 Push-to-Talk 模式;Claude Code 更新：优化全屏渲染与 MCP 稳定性, 引入流式思考输出;LLM Sleep 机制发布：通过类睡眠离线递归提升长上下文推理…"
date: 2026-05-28
---
